...
# ------------------------------------------------------------
# 6. TRANSPOSED PLOT: REQUIREMENTS AS COLUMNS
# ------------------------------------------------------------
...
# Figure width adapts to number of requirements
...
axes[2].set_title(
    "C. Divergence: domain-specific inclusion minus student MUST",
    fontsize=12,
    fontweight="bold",
    loc="left",
    pad=8
...
axes[2].set_yticks([0])
axes[2].set_yticklabels(["Delta"], fontsize=10)
...
output_png = SCRIPT_DIR / "requirement_domain_vs_student_must_transposed.png"
output_jpg = SCRIPT_DIR / "requirement_domain_vs_student_must_transposed.jpg"
